...
public class JedisCacheFetchManage {
     ...
     * 将方案风控资产数据放入缓存中
     */
    public static void putSchemeRiskToJedis(String system, String key, Object cacheValue) {
        synchronized (atomic) {
            ...
            JedisPull.setObject(system, key, cacheValue);
        }
    }
     ...
     * @return
     */
    public static <T> T getSchemeRiskFromJedis(String system, String key, Class<T> clazz) {
        synchronized (atomic) {
            ...
            T cacheValue = JedisPull.getObject(system, key, clazz);
     ...
     * 将数据放入缓存中
     */
    public static void putCacheToJedis(String system, String key, Object cacheValue) {
//        cacheKey = key;
     ...
     * @return
     */
    public static <T> T getCacheFromJedis(String system, String key, Class<T> clazz) {
//        cacheKey = key;
        synchronized (cacheKey) {
            T cacheValue = JedisPull.getObject(system, key, clazz);
            return cacheValue;
